...
<template>
	<div
		...
		<div class="px-4 py-2 dark:bg-gray-800 rounded-md w-full flex flex-col items-center justify-start space-y-2">
			<div class="text-xs flex flex-col lg:flex-row items-center justify-between w-full">
				<div class="text-sm font-bold flex flex-row items-center justify-center text-primary">
					<UIcon name="bxs:time-five" size="12" class="hidden lg:inline mr-1" />
					<p class="">{{data['time']}}</p>
				</div>
				<div class="text-sm font-bold flex flex-row items-center justify-center text-primary">
			...
			<div class="text-xs flex flex-col-reverse lg:flex-row items-center justify-center lg:justify-between w-full space-x-2">
